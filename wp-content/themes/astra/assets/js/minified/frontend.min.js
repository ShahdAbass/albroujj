    ...
    function n(e) {
        ...
        if ("off-canvas" === e) {
            ...
            for (s.addEventListener("click", function(e) {
                ...
                }), link = 0, len = popupLinks.length; link < len; link++) null === popupLinks[link].getAttribute("href") || "#" != popupLinks[link].getAttribute("href") || popupLinks[link].parentElement.classList.contains("menu-item-has-children") || (popupLinks[link].addEventListener("click", g, !0), popupLinks[link].headerType = "off-canvas");
            AstraToggleSetup()
        } else if ("dropdown" === e) {
            ...
            for (link = 0, len = l.length; link < len; link++) null === l[link].getAttribute("href") || "#" != l[link].getAttribute("href") || l[link].parentElement.classList.contains("menu-item-has-children") || (l[link].addEventListener("click", g, !0), l[link].headerType = "dropdown");
